...
import {GET_BY_ID, GET_LIST, SET, UPDATE_FIELD, UPDATE_PICTURE} from "../types";
...
export default class Actions {
    ...
    [UPDATE_FIELD] = ({key, value, field, map}) => async (dispatch) => {
        dispatch({
            ...
            payload: {value, key, map, field},
        });
    }
    [SET] = ({key, value}) => async (dispatch) => {
        dispatch({
            type: this.reducerContext.actionTypes['SET'],
            payload: value,
            key
        });
    }
